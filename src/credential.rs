...
impl BaseCredential {
    ...
    pub fn compatible_with(&self, candidate: &Self, now: OffsetDateTime) -> bool {
        ...
        self.profile == candidate.profile
            && self.authority_fingerprint == candidate.authority_fingerprint
    }
}
...
impl ScopedCredential {
    pub fn compatible_with(&self, candidate: &Self, now: OffsetDateTime) -> bool {
        ...
        self.profile == candidate.profile
            && self.source_profile == candidate.source_profile
            && self.source_authority_fingerprint == candidate.source_authority_fingerprint
            && self.repo_scope == candidate.repo_scope
            && self.parent_generation == candidate.parent_generation
            && self.policy_fingerprint == candidate.policy_fingerprint
    }
}
